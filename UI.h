...
inline void text_ui(string output,int mode){
	...
	cout<<"      ##                                               ##"<<endl;
	cout<<"      ##";
	int temp=(47-output.length())/2;
	for(int i=0;i<temp;i++) printf("%c",' ');
	cout<<output;
	if((47-output.length())%2==1) temp++;
	for(int i=0;i<temp;i++) printf("%c",' ');
	cout<<"##"<<endl;
	cout<<"      ##                                               ##"<<endl;
	cout<<"      ##                                               ##"<<endl;
...
inline void text_long(string *output,int mode,int ti){
	const string err_str="      ######### ! ! ! ! !  E r r o r  ! ! ! ! ! #########";
	const string war_str="      ########## ! ! ! ! W a r n i n g ! ! ! ! ##########";
	const string not_str="      ################## ! N o t e ! ####################";
	system("cls");
	...
	for(int i=0;i<ti;i++){
		cout<<"      ##";
		int temp=(47-output[i].length())/2;
		for(int i=0;i<temp;i++) printf("%c",' ');
		cout<<output[i];
		if((47-output[i].length())%2==1) temp++;
		for(int i=0;i<temp;i++) printf("%c",' ');
		cout<<"##"<<endl;
	}
	cout<<"      ##                                               ##"<<endl;
