...
inline void clog_h(){
	...
	cout<<"The default password for Hit mode is 654321, and the default password for User mode is 123456.";
	cout<<"*****************************************************\n";
	cout<<"Hitmux 1.2.0-bate (C) 2024 CaoKai,All right reserved.\n";
